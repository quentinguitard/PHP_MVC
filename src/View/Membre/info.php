<div class="container mt-5 mb-5">
    <div class="row d-flex justify-content-center">
        <div class="col-4 background-white-light-7 rounded p-3">
            <h6>Nom : </h6>
            <h4>{{ucfirst($membreDetail['nomUser'])}}</p>
            <h6>Email :</h6>
            <h4>{{$membreDetail['email']}}</h4>
            <h6>Code Postal :</h6>
            <h4>{{$membreDetail['cpostal']}}</h4>
        </div>
        <div class="col-4 background-white-light-7 rounded p-3">
            <h6>Prenom :</h6>
            <h4>{{ucfirst($membreDetail['prenomUser'])}}</h4>
            <h6>Abonnement :</h6>
            <h4>{{$membreDetail['nomAbo']}}</h4>
            <h6>Ville :</h6>
            <h4>{{$membreDetail['ville']}}</h4>
        </div>
    </div>
</div>
<div class="container mt-5 mb-5">
...
<div class="container mt-4">
    <div class="row">
        <table class="table background-white-light table-striped">
            ...
            <tbody>
                @foreach($historiqueMembre as $values)
