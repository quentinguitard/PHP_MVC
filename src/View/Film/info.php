<div class="container mt-4">
    <div class="row">
        ...
        <div class="col d-flex flex-column justify-content-end ">
            ...
            <h6 class="border background-white-light-7 rounded p-2">Genre: {{$genreNom['nom_genre']}}</h6>
            @!empty ($distribNom)
            <h6 class="border background-white-light-7 rounded p-2">Distributeur: {{$distribNom[0]['nom_distrib']}}</h6>
            @endisset
        </div>
    </div>
